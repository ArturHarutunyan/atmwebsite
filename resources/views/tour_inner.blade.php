            ...
            <aside class="tourInner-content__aside">
                ...
                <div class="turs_items_container">
                    ...
                    <div class="tours_slider_container">
                        <div class="slider">
                            <div class="controls slide_change_container" style="
                                                                                height: 100%;
                                                                                top: 0;
                                                                                display: flex;
                                                                                max-height: 400px;
                ...
                <div class="tours_slider_container">
                    <div class="slider">
                        ...
                        <div class="controls slide_change_container" style=" height: 100%;
                                                                                top: 0;
                                                                                display: flex;
                                                                                max-height: 400px;
                                                                                align-items: center">
