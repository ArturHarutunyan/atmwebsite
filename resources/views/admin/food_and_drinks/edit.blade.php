...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <h2>
                {{trans('admin.edit_the_food_and_drink')}}
            </h2>
            <form action="{{route('food_and_drink.update',['id'=>$food_and_drink->id])}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    @if($food_and_drink->image)
                        <img class="img-responsive old-image" src="{{asset($food_and_drink->image)}}">
                    @endif
