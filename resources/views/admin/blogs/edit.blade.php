        ...
        <div class="panel-body">
            ...
            <form action="{{route('blog.update',['id'=>$blog->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        @if($blog->hasTranslation($lang))
                            <div id="{{$lang}}" class="tab-pane fade @if(App::isLocale($lang))in active @endif">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_{{$lang}}" id="title_{{$lang}}" value="{{$blog->getTranslation($lang)->title}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="text_content_{{$lang}}">{{Lang::get('admin.text_content',[],$lang)}}</label>
                                    <textarea id="text_content_{{$lang}}" class="ckeditor-content" name="text_content_{{$lang}}" class="form-control">{{$blog->getTranslation($lang)->text_content}}</textarea>
                                </div>
                            </div>
                        @endif
                    @endforeach
                ...
                <div class="form-group">
                    ...
                    @if($blog->image)
                        <img class="img-responsive old-image" src="{{asset($blog->image)}}">
                    @endif
