...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <h2>
                {{trans('admin.edit_the_about_page_content')}}
            </h2>
            <form action="{{route('about_content.update',['id'=>$about_content->id])}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <textarea id="why_me_first_image" class="ckeditor-content form-control" name="why_me_first_image">{!! $about_content->why_me_first_image !!}</textarea>
                </div>
                <div class="form-group">
                    <label for="why_me_second_image">{{trans('admin.why_me_second_image')}}</label>
                    <textarea id="why_me_second_image" class="ckeditor-content form-control" name="why_me_second_image">{!! $about_content->why_me_second_image !!}</textarea>
                </div>
                <div class="form-group">
                    <label for="why_me_third_image">{{trans('admin.why_me_third_image')}}</label>
                    <textarea id="why_me_third_image" class="ckeditor-content form-control" name="why_me_third_image">{!! $about_content->why_me_third_image !!}</textarea>
                </div>
                <div class="form-group">
                    <label for="why_me_fourth_image">{{trans('admin.why_me_fourth_image')}}</label>
                    <textarea id="why_me_fourth_image" class="ckeditor-content form-control" name="why_me_fourth_image">{!! $about_content->why_me_fourth_image !!}</textarea>
                </div>
                <div class="form-group">
