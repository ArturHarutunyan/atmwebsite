...
@section('content')
    ...
    <div class="hiddenScrollbar"><div > </div> </div>
    <div class="svgContainer">
        ...
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" viewbox="-1600 0 2900 200" id="SVGpath" style='overflow:visible'  fill="none" preserveAspectRatio="none" >
         ...
         M 1256 -1205 Q 630 -561 184 -709Q -400 -904 -1043 -521Q -1800 -80.4355 -1300 300    "  ></path>
            ...
            <mask id="mask1"><use class="mask" xlink:href="#first_path_background"></mask>
    ...
    <main class="main">
        ...
        <!-- gallery section -->
        <section 
         class="gallery mobileTopAnimation fullRigth opacity_03 transition_1s position_relative higherThanSvg">
